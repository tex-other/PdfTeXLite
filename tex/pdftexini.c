...
initialize ( void ) 
{
  ...
  if ( iniversion ) 
  {
    ...
    trieopptr = 0 ;
    trienotready = true ;
    hash [15514 ].v.RH = 1602 ;
    if ( iniversion ) 
    formatident = 1679 ;
    hash [15522 ].v.RH = 1891 ;
    eqtb [15522 ].hh.b1 = 1 ;
...
znewtrieop ( smallnumber d , smallnumber n , trieopcode v ) 
{
  ...
  while ( true ) {
    ...
    if ( l == 0 ) 
    {
      ...
      overflow ( 1355 , trieopsize ) ;
      u = trieused [curlang ];
      if ( u == maxtrieop ) 
      overflow ( 1356 , maxtrieop - mintrieop ) ;
      incr ( trieopptr ) ;
      incr ( u ) ;
      trieused [curlang ]= u ;
      if ( u > maxopused ) 
...
storefmtfile ( void ) 
{
  ...
  packjobname ( 934 ) ;
  while ( ! wopenout ( fmtfile ) ) promptfilename ( 1700 , 934 ) ;
  printnl ( 1701 ) ;
...
initprim ( void ) 
{
  ...
  primitive ( 1300 , 4 , 256 ) ;
  primitive ( 1301 , 5 , 257 ) ;
  hash [15515 ].v.RH = 1301 ;
  eqtb [15515 ]= eqtb [curval ];
  primitive ( 1302 , 5 , 258 ) ;
  hash [15519 ].v.RH = 1303 ;
  hash [15520 ].v.RH = 1303 ;
  eqtb [15520 ].hh.b0 = 9 ;
  ...
  primitive ( 1465 , 20 , 4 ) ;
  primitive ( 1375 , 20 , 5 ) ;
  primitive ( 1466 , 20 , 108 ) ;
  primitive ( 1467 , 31 , 99 ) ;
  primitive ( 1468 , 31 , 100 ) ;
  primitive ( 1469 , 31 , 101 ) ;
  primitive ( 1470 , 31 , 102 ) ;
  primitive ( 1486 , 43 , 1 ) ;
  primitive ( 1487 , 43 , 0 ) ;
  primitive ( 1488 , 43 , 2 ) ;
  primitive ( 1498 , 25 , 12 ) ;
  primitive ( 1499 , 25 , 11 ) ;
  primitive ( 1500 , 25 , 10 ) ;
  primitive ( 1501 , 23 , 0 ) ;
  primitive ( 1502 , 23 , 1 ) ;
  primitive ( 1503 , 24 , 0 ) ;
  primitive ( 1504 , 24 , 1 ) ;
  ...
  primitive ( 1535 , 48 , 0 ) ;
  primitive ( 1536 , 48 , 1 ) ;
  primitive ( 1267 , 50 , 16 ) ;
  primitive ( 1268 , 50 , 17 ) ;
  primitive ( 1269 , 50 , 18 ) ;
  primitive ( 1270 , 50 , 19 ) ;
  primitive ( 1271 , 50 , 20 ) ;
  primitive ( 1272 , 50 , 21 ) ;
  primitive ( 1273 , 50 , 22 ) ;
  primitive ( 1274 , 50 , 23 ) ;
  primitive ( 1276 , 50 , 26 ) ;
  primitive ( 1275 , 50 , 27 ) ;
  primitive ( 1537 , 51 , 0 ) ;
  primitive ( 1280 , 51 , 1 ) ;
  primitive ( 1281 , 51 , 2 ) ;
  primitive ( 1262 , 53 , 0 ) ;
  ...
  primitive ( 1559 , 52 , 4 ) ;
  primitive ( 1560 , 52 , 5 ) ;
  primitive ( 1277 , 49 , 30 ) ;
  primitive ( 1278 , 49 , 31 ) ;
  hash [15517 ].v.RH = 1278 ;
  ...
  primitive ( 1639 , 78 , 8 ) ;
  primitive ( 1640 , 78 , 9 ) ;
  primitive ( 1641 , 78 , 10 ) ;
  primitive ( 1642 , 78 , 11 ) ;
  primitive ( 1643 , 78 , 6 ) ;
  primitive ( 274 , 100 , 0 ) ;
  primitive ( 275 , 100 , 1 ) ;
  primitive ( 276 , 100 , 2 ) ;
  primitive ( 1651 , 100 , 3 ) ;
  primitive ( 1652 , 60 , 1 ) ;
  primitive ( 1653 , 60 , 0 ) ;
  primitive ( 1654 , 58 , 0 ) ;
  primitive ( 1655 , 58 , 1 ) ;
  primitive ( 1661 , 57 , 27994 ) ;
  primitive ( 1662 , 57 , 28250 ) ;
  primitive ( 1663 , 19 , 0 ) ;
  primitive ( 1664 , 19 , 1 ) ;
  primitive ( 1665 , 19 , 2 ) ;
  primitive ( 1666 , 19 , 3 ) ;
  ...
  primitive ( 1714 , 59 , 2 ) ;
  primitive ( 1715 , 59 , 3 ) ;
  hash [15524 ].v.RH = 1715 ;
  eqtb [15524 ]= eqtb [curval ];
  primitive ( 1716 , 59 , 4 ) ;
  primitive ( 1717 , 59 , 5 ) ;
  primitive ( 1718 , 59 , 6 ) ;
  primitive ( 1128 , 59 , 38 ) ;
  primitive ( 1719 , 59 , 39 ) ;
  primitive ( 1720 , 59 , 40 ) ;
  primitive ( 1721 , 59 , 41 ) ;
  primitive ( 1722 , 59 , 7 ) ;
  primitive ( 1723 , 59 , 8 ) ;
  primitive ( 1724 , 59 , 9 ) ;
  primitive ( 1725 , 59 , 10 ) ;
  primitive ( 1726 , 59 , 11 ) ;
  primitive ( 1727 , 59 , 12 ) ;
  primitive ( 1728 , 59 , 13 ) ;
  primitive ( 1729 , 59 , 14 ) ;
  primitive ( 1730 , 59 , 15 ) ;
  primitive ( 1731 , 59 , 16 ) ;
  primitive ( 1732 , 59 , 17 ) ;
  primitive ( 1733 , 59 , 18 ) ;
  primitive ( 1734 , 59 , 19 ) ;
  primitive ( 1735 , 59 , 20 ) ;
  primitive ( 1736 , 59 , 21 ) ;
  primitive ( 1737 , 59 , 34 ) ;
  primitive ( 1738 , 59 , 35 ) ;
  primitive ( 1739 , 59 , 36 ) ;
  primitive ( 1740 , 59 , 22 ) ;
  primitive ( 1741 , 59 , 23 ) ;
  primitive ( 1742 , 59 , 24 ) ;
  primitive ( 1743 , 59 , 26 ) ;
  primitive ( 1744 , 59 , 25 ) ;
  primitive ( 1745 , 59 , 27 ) ;
  primitive ( 1746 , 59 , 28 ) ;
  primitive ( 1747 , 59 , 29 ) ;
  primitive ( 1748 , 59 , 30 ) ;
  primitive ( 1749 , 59 , 31 ) ;
  primitive ( 1750 , 59 , 33 ) ;
  primitive ( 1751 , 59 , 32 ) ;
  primitive ( 1752 , 59 , 37 ) ;
  primitive ( 1753 , 59 , 42 ) ;
  primitive ( 1754 , 59 , 43 ) ;
  primitive ( 1755 , 59 , 44 ) ;
  primitive ( 1756 , 59 , 45 ) ;
  nonewcontrolsequence = true ;
} 
#endif /* INITEX */
void 
mainbody ( void ) 
{
  ...
  if ( 255 < 255 ) 
  bad = 19 ;
  if ( 34271L + hashextra > 268435455L ) 
  bad = 21 ;
  ...
  outputfilename = 0 ;
  {
    ...
    == 1679 ) ) 
    {
      nonewcontrolsequence = false ;
      primitive ( 1949 , 70 , 3 ) ;
      primitive ( 1950 , 70 , 20 ) ;
      primitive ( 867 , 110 , 5 ) ;
      primitive ( 1952 , 72 , 27172 ) ;
      primitive ( 1953 , 73 , 29365 ) ;
      primitive ( 1954 , 73 , 29366 ) ;
      primitive ( 1955 , 73 , 29367 ) ;
      primitive ( 1956 , 73 , 29368 ) ;
      primitive ( 1957 , 73 , 29369 ) ;
      primitive ( 1958 , 73 , 29370 ) ;
      primitive ( 1959 , 73 , 29371 ) ;
      primitive ( 1960 , 73 , 29372 ) ;
      primitive ( 1961 , 73 , 29373 ) ;
      primitive ( 1976 , 70 , 21 ) ;
      primitive ( 1977 , 70 , 22 ) ;
      primitive ( 1978 , 70 , 23 ) ;
      primitive ( 1979 , 70 , 24 ) ;
      primitive ( 1980 , 70 , 25 ) ;
      primitive ( 1981 , 70 , 28 ) ;
      primitive ( 1982 , 70 , 29 ) ;
      primitive ( 1983 , 70 , 30 ) ;
      primitive ( 1984 , 70 , 31 ) ;
      primitive ( 1985 , 70 , 32 ) ;
      primitive ( 1986 , 70 , 33 ) ;
      primitive ( 1987 , 70 , 34 ) ;
      primitive ( 1988 , 19 , 4 ) ;
      primitive ( 1990 , 19 , 5 ) ;
      primitive ( 1991 , 111 , 1 ) ;
      primitive ( 1992 , 111 , 5 ) ;
      primitive ( 1993 , 19 , 6 ) ;
      primitive ( 1997 , 82 , 2 ) ;
      primitive ( 1279 , 49 , 1 ) ;
      primitive ( 2001 , 73 , 29374 ) ;
      primitive ( 2002 , 33 , 6 ) ;
      primitive ( 2003 , 33 , 7 ) ;
      primitive ( 2004 , 33 , 10 ) ;
      primitive ( 2005 , 33 , 11 ) ;
      primitive ( 2014 , 106 , 2 ) ;
      primitive ( 2016 , 96 , 1 ) ;
      primitive ( 923 , 104 , 1 ) ;
      primitive ( 2017 , 107 , 17 ) ;
      primitive ( 2018 , 107 , 18 ) ;
      primitive ( 2019 , 107 , 19 ) ;
      primitive ( 2020 , 107 , 20 ) ;
      primitive ( 2021 , 107 , 22 ) ;
      primitive ( 2022 , 107 , 23 ) ;
      primitive ( 1594 , 93 , 8 ) ;
      primitive ( 2028 , 70 , 39 ) ;
      primitive ( 2029 , 70 , 40 ) ;
      primitive ( 2030 , 70 , 41 ) ;
      primitive ( 2031 , 70 , 42 ) ;
      primitive ( 2035 , 70 , 26 ) ;
      primitive ( 2036 , 70 , 27 ) ;
      primitive ( 2037 , 70 , 35 ) ;
      primitive ( 2038 , 70 , 36 ) ;
      primitive ( 2039 , 70 , 37 ) ;
      primitive ( 2040 , 70 , 38 ) ;
      primitive ( 2041 , 18 , 5 ) ;
      primitive ( 2042 , 112 , 5 ) ;
      primitive ( 2043 , 112 , 6 ) ;
      primitive ( 2044 , 112 , 7 ) ;
      primitive ( 2045 , 112 , 8 ) ;
      primitive ( 2046 , 112 , 9 ) ;
      primitive ( 2050 , 24 , 2 ) ;
      primitive ( 2051 , 24 , 3 ) ;
      primitive ( 2052 , 84 , 27429 ) ;
      primitive ( 2053 , 84 , 27430 ) ;
      primitive ( 2054 , 84 , 27431 ) ;
      primitive ( 2055 , 84 , 27432 ) ;
    ...
    magicoffset = strstart [1294 ]- 9 * 16 ;
    if ( interaction == 0 ) 
    selector = 16 ;
    else selector = 17 ;

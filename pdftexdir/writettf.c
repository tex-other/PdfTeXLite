...
void ttf_init()
{
    ...
    //new_cmap_tab[NEW_CMAP_SIZE];
    memset(new_cmap_tab, 0, NEW_CMAP_SIZE * sizeof(cmap_entry));
    name_tab = 0;
    name_record_num = 0;
    name_buf = 0;
    name_buf_size = 0;
    ...
    tab_length = 0;
    tmp_ulong = 0;
    checkSumAdjustment_offset = 0;
    ttf_file = 0;

    memset(ttfenc_tab, 0, sizeof(ttfenc_entry) * 256);

    fd_cur = 0;        /* pointer to the current font descriptor */
